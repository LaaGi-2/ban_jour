...
function createNavbar() {
    return `
<header id="navbar"
        class="fixed inset-x-0 top-0 z-50 bg-[#00000080] shadow-md transition-all duration-300 m-4 rounded-lg">
        <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">

            <div class="flex lg:flex-1">
                <a href="#" class="-m-1.5 p-1.5">
                    <span class="sr-only">Your Company</span>
                    <img id="navbar-logo" class="h-20 w-auto absolute top-1" src="images/logos/logo-transparent.png"
                        alt="" />
                </a>
            </div>
                ...
                <div class="relative inline-block text-left">
                    <div>
                        <button id="menu-button" type="button"
                            class="inline-flex w-full justify-normal gap-x-1 rounded-md bg-white px-3 py-1 text-sm font-semibold text-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
